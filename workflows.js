...
async function restoreAtlasState(){
 ...
 if(manifest.comparison_exclusions?.[metric])toast('That indicator has been removed from comparisons. Showing income deprivation.');
