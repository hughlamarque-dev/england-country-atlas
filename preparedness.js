...
function renderPartners(){
 const matches=filteredPartners();$('partnerCount').textContent=matches.length+' shown · '+foundationFeatures.length+' community foundations + '+resilienceData.records.length+' resilience forums in this directory';$('partnersExport').disabled=!matches.length;const box=$('partnerCards');box.replaceChildren();
