...
function catalogueRows(){
 ...
 rows.push({id:'volunteering_pilot',title:'Resilience volunteering directory',group:'Local partners',format:'referral directory',period:'Public sources checked 18 September 2026',source:'Host and local broker websites',source_url:'volunteering.html',coverage:'England: nine regions and 296 council search areas; researched listings remain uneven',interpretation:'Published opportunities and enquiry routes are distinct. Source checks do not establish host-confirmed places or NET endorsement. Activity locations, offices and area markers are identified separately. Listings move out of active results after their end, application or review date.'});
 rows.push({id:'volunteering_partners',title:'Local volunteering connections',group:'Local partners',format:'directory',period:'Sources checked 18 September 2026',source:'Local broker and community network websites',source_url:'data/volunteering-partners.json',coverage:volunteeringPartners.length+' sourced entries across England',interpretation:'Local infrastructure and coordination routes; not a complete England-wide volunteer-centre directory. Coverage notes are sourced descriptions, not service-area polygons.'});
 return rows;
}
