...
Live QA for release 2026.09.18.11 confirmed council selection, regional broadening, Manchester postcode lookup, 24-record pagination with keyboard focus, team-format filtering, detailed source notes, and a 375-pixel content width without horizontal overflow. Contact links use `mailto:hugh.lamarque@gmail.com`. The national view groups nearby map positions at lower zoom levels; these display groups do not change source geography.
